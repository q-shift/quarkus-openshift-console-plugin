 ...
 HttpHeaders headers;
  ...
  public Response proxy(String namespace, String name, String path) {
       ...
       return client
            ...
            .send()
            .toCompletionStage()
            .thenApply(response -> mapResponse(response, s -> mapUrl(s, namespace, name)))
            .toCompletableFuture()
            .join();
  }
   ...
   public String mapUrl(String url, String namespace, String name) {
      ...
      String prefix ="/api/proxy/plugin/quarkus-openshift-console-plugin/service-proxy/produi/" + namespace + "/" + name;
